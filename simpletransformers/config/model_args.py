...
@dataclass
class MultitaskClassificationArgs(ModelArgs):
    """
    Model args for a ClassificationModel
    """

    model_class: str = "MultitaskClassificationModel"
    labels_list_1: list = field(default_factory=list)
    labels_list_2: list = field(default_factory=list)
    labels_map_1: dict = field(default_factory=dict)
    labels_map_2: dict = field(default_factory=dict)
    lazy_delimiter: str = "\t"
    lazy_labels_column: int = 1
    lazy_loading: bool = False
    lazy_loading_start_line: int = 1
